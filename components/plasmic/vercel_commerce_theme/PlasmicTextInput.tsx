...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: uSB6o4sitQxH/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg___3Ugro)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___7SXuO)}
              role={"img"}
            />
          ),
